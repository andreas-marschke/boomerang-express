...
module.exports.collectionName = function(collection, webcollection) {
  this.log.debug({ webcollectionName: webcollection.name, givenName: collection }, "Matching webcollection.name: " + webcollection.name + ", and given collection: " + collection );
