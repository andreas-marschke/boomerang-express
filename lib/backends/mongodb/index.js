...
Datastore.prototype.collectionExists = function(type, user, collection, site, callback) {
    ...
    this.pDatabase.collection("webcollections", { strict: true }, function(err, webcollections) {
...
Datastore.prototype.insertIntoCollection = function(collection, data, type){
    ...
    this.pDatabase.collection(collection, {w: 1, strict: true}, function(err, userCollection) {
