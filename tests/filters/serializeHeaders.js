...
describe("Filters serializeHeaders():",  function() {
  ...
  it("Should serialize and split 'accept' headers", function(){
    ...
    var headers = { "accept-encoding": "gzip,deflate,sdch", "accept-language": "de-DE,de;q=0.8,en-US;q=0.6,en;q=0.4" };
    var expected = {"accept-encoding": ["gzip", "deflate", "sdch"], "accept-language": ["de-DE", { name: "de", "rank": "0.8"}, {name: "en-US", rank: "0.6"}, {name: "en", rank: "0.4"}]};
